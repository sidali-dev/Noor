  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Container(
          color: const Color.fromARGB(255, 63, 33, 99),
          child: Column(
            children: [
                              ...
                              GestureDetector(
                                onTap: () async {
                                  showDialog(
                                      barrierDismissible: false,
                                      context: Get.context!,
                                      builder: (context) => WaitDialog(
                                          isDark: true, isRtl: isRtl));
                                  if (await SHelperFunctions
                                      .isInternetConnected()) {
                                    Get.back();
                                    Map response;
                                ...
                                IconButton(
                                    onPressed: () {
                                      if (controller.date.value ==
                                          DateTime(controller.date.value.year,
                                              1, 1)) {
                                        showDialog(
                                            context: context,
                                            builder: (context) => CheckDialog(
                                                title: S.of(context).year_ended,
                                                imagePath: SImageString
                                                    .lottieCalendarOut,
                                                color: Colors.red));
                                      } else {
